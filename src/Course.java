...
public class Course {
    ...
    public void writeCourseToDB(Connection conn)
        ...
        String courseQuery = "INSERT INTO Course ("
                + " Name,"
                + " [State],"
                + " Tees) VALUES ("
                + "?, ?, ?)";
        String holeQuery = "INSERT INTO Hole ("
                + " Number,"
                + " Par,"
                + " Handicap,"
                + " Yardage,"
    ...
    public void getHoles(Connection conn)
        ...
        //set query
        String query = "SELECT Number, Par, Handicap, Yardage FROM Hole " +
                "INNER JOIN Course ON Hole.CourseID = Course.CourseID " +
